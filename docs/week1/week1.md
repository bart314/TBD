...
We will talk about the way buildings form space in the same way that rituals form time. We follow [Martin Heidegger's](https://en.wikipedia.org/wiki/Martin_Heidegger) lead, when he states that mankind *is* only in so far as we *build*:
